 ...
 *
 */
public class Right_RightSwitch_One extends CommandGroup implements RobotMap{

    public Right_RightSwitch_One() {
    	System.out.println("right to right switch, one cube");
