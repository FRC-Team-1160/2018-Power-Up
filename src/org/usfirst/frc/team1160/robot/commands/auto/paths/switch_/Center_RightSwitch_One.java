 ...
 *
 */
public class Center_RightSwitch_One extends CommandGroup implements RobotMap{

    public Center_RightSwitch_One() {
    	System.out.println("center to right switch, one cube");
