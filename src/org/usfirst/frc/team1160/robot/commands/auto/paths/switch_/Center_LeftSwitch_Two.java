 ...
 *
 */
public class Center_LeftSwitch_Two extends CommandGroup implements RobotMap{

    public Center_LeftSwitch_Two() {
    	System.out.println("center to left switch, two cube");
