package org.usfirst.frc.team1160.robot.subsystems.modifiedClasses;

import jaci.pathfinder.Trajectory;
import jaci.pathfinder.followers.EncoderFollower;

public class EncoderFollowerPlus extends EncoderFollower{
    ...
    public EncoderFollowerPlus(Trajectory traj) {
        this.trajectory = traj;
    }

    public EncoderFollowerPlus() { }
    ...
    public void resetBackwards() {
        last_error = 0; segment = trajectory.length()-1;
    }
    ...
    public double calculateBackwards(int encoder_tick) {
        // Number of Revolutions * Wheel Circumference
        double distance_covered = ((double)(encoder_tick - encoder_offset) / encoder_tick_count)
                * wheel_circumference;
        if (segment > 0) {
